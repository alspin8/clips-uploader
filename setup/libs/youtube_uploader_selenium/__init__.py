...
class YouTubeUploader:
    ...
    def __init__(self, video_path: str, metadata_json_path: Optional[str] = None, logger=None) -> None:
    ...
    def __upload(self) -> (bool, Optional[str]):
        ...
        if video_description:
            ...
            time.sleep(Constant.USER_WAITING_TIME)
            for key, value in self.metadata_dict[Constant.VIDEO_DESCRIPTION].items():   
